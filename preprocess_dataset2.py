...
def main():
    ...
    np.save("path_source_token_idxs.npy", path_source_token_idxs)
    np.save("path_idxs.npy", path_idxs)
    np.save("path_target_token_idxs.npy", path_target_token_idxs)
    np.save("context_valid_masks.npy", context_valid_masks)
    np.save("Y.npy", Y)
